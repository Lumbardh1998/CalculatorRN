...
// Cache për ruajtjen e operatorëve (në vend që të instantohen të rinj).
// Për të krijuar një operator të ri, shtojeni atë në cache si një operator të ri global.swisscalc.lib., duke plotësuar funksionin e vetive dhe vlerësimin().
